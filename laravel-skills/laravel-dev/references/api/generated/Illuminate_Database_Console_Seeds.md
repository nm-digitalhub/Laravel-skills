...
## class SeedCommand
`Illuminate\Database\Console\Seeds\SeedCommand` extends Illuminate\Console\Command implements Symfony\Component\Console\Command\SignalableCommandInterface

```php
function __call($method, $parameters);
function __construct(Illuminate\Database\ConnectionResolverInterface $resolver);
...
`Illuminate\Database\Console\Seeds\SeederMakeCommand` extends Illuminate\Console\GeneratorCommand implements Illuminate\Contracts\Console\PromptsForMissingInput, Symfony\Component\Console\Command\SignalableCommandInterface
