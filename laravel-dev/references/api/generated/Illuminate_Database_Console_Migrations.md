...
## class BaseCommand
`Illuminate\Database\Console\Migrations\BaseCommand` extends Illuminate\Console\Command implements Symfony\Component\Console\Command\SignalableCommandInterface
...
## class FreshCommand
`Illuminate\Database\Console\Migrations\FreshCommand` extends Illuminate\Console\Command implements Symfony\Component\Console\Command\SignalableCommandInterface

```php
function __call($method, $parameters);
function __construct(Illuminate\Database\Migrations\Migrator $migrator);
function addArgument(string $name, ?int $mode = null, string $description = '', mixed $default = null, Closure|array $suggestedValues = []): static;
function addOption(string $name, array|string|null $shortcut = null, ?int $mode = null, string $description = '', mixed $default = null, Closure|array $suggestedValues = []): static;
function addUsage(string $usage): static;
function alert($string, $verbosity = null);
...
`Illuminate\Database\Console\Migrations\InstallCommand` extends Illuminate\Console\Command implements Symfony\Component\Console\Command\SignalableCommandInterface

```php
function __call($method, $parameters);
function __construct(Illuminate\Database\Migrations\MigrationRepositoryInterface $repository);
function addArgument(string $name, ?int $mode = null, string $description = '', mixed $default = null, Closure|array $suggestedValues = []): static;
function addOption(string $name, array|string|null $shortcut = null, ?int $mode = null, string $description = '', mixed $default = null, Closure|array $suggestedValues = []): static;
function addUsage(string $usage): static;
function alert($string, $verbosity = null);
...
`Illuminate\Database\Console\Migrations\MigrateCommand` extends Illuminate\Database\Console\Migrations\BaseCommand implements Symfony\Component\Console\Command\SignalableCommandInterface, Illuminate\Contracts\Console\Isolatable

```php
function __call($method, $parameters);
function __construct(Illuminate\Database\Migrations\Migrator $migrator, Illuminate\Contracts\Events\Dispatcher $dispatcher);
function addArgument(string $name, ?int $mode = null, string $description = '', mixed $default = null, Closure|array $suggestedValues = []): static;
function addOption(string $name, array|string|null $shortcut = null, ?int $mode = null, string $description = '', mixed $default = null, Closure|array $suggestedValues = []): static;
function addUsage(string $usage): static;
function alert($string, $verbosity = null);
...
`Illuminate\Database\Console\Migrations\MigrateMakeCommand` extends Illuminate\Database\Console\Migrations\BaseCommand implements Symfony\Component\Console\Command\SignalableCommandInterface, Illuminate\Contracts\Console\PromptsForMissingInput

```php
function __call($method, $parameters);
function __construct(Illuminate\Database\Migrations\MigrationCreator $creator, Illuminate\Support\Composer $composer);
function addArgument(string $name, ?int $mode = null, string $description = '', mixed $default = null, Closure|array $suggestedValues = []): static;
function addOption(string $name, array|string|null $shortcut = null, ?int $mode = null, string $description = '', mixed $default = null, Closure|array $suggestedValues = []): static;
function addUsage(string $usage): static;
function alert($string, $verbosity = null);
...
`Illuminate\Database\Console\Migrations\RefreshCommand` extends Illuminate\Console\Command implements Symfony\Component\Console\Command\SignalableCommandInterface
...
## class ResetCommand
`Illuminate\Database\Console\Migrations\ResetCommand` extends Illuminate\Database\Console\Migrations\BaseCommand implements Symfony\Component\Console\Command\SignalableCommandInterface
...
`Illuminate\Database\Console\Migrations\RollbackCommand` extends Illuminate\Database\Console\Migrations\BaseCommand implements Symfony\Component\Console\Command\SignalableCommandInterface
...
## class StatusCommand
`Illuminate\Database\Console\Migrations\StatusCommand` extends Illuminate\Database\Console\Migrations\BaseCommand implements Symfony\Component\Console\Command\SignalableCommandInterface
